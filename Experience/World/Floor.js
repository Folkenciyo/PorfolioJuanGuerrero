...
export default class Floor {
    ...
    setFloor() {
        ...
        this.material = new THREE.MeshStandardMaterial( {color: 0xE3CBA7, side: THREE.BackSide} );
    ...
    setCircles(){
        ...
        const material = new THREE.MeshStandardMaterial({color: 0x7A5252})
        const material2 = new THREE.MeshStandardMaterial({color: 0x958acf})
        const material3 = new THREE.MeshStandardMaterial({color: 0xc1a570})
